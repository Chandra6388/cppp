  ...
  return <div className="min-h-screen pt-20 creative-gradient">
      ...
      <section id="core-services" data-section className="py-32 section-dark">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
          ...
          }].map((service, index) => <div key={index} className={`creative-card p-10 rounded-3xl transition-all duration-700 ${isSectionVisible('core-services') ? 'animate-scale-in' : 'opacity-0'}`} style={{
            animationDelay: `${index * 200}ms`
                ...
                <ul className="space-y-3">
                  {service.features.map((feature, idx) => <li key={idx} className="flex items-center text-gray-300 font-light">
      ...
      <section id="premium-services" data-section className="py-32 section-dark">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          }].map((service, index) => <div key={index} className={`creative-card p-8 rounded-3xl transition-all duration-700 ${isSectionVisible('premium-services') ? 'animate-fade-in-up' : 'opacity-0'}`} style={{
            animationDelay: `${index * 150}ms`
                ...
                <ul className="space-y-2">
                  {service.highlights.map((highlight, idx) => <li key={idx} className="flex items-center text-sm text-gray-300 font-light">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isSectionVisible('cta') ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button size="lg" className="btn-dark-modern text-white font-light text-xl px-12 py-8 rounded-2xl">
                <Zap className="w-6 h-6 mr-3" />
                Start Your Journey
              </Button>
              <Button size="lg" variant="outline" className="btn-accent-dark font-light text-xl px-12 py-8 rounded-2xl">
