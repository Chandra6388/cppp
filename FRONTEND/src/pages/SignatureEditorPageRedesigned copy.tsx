...
const SignatureEditorPageRedesigned = () => {
  ...
  const templatesArr = [
    {
      ...
      html:
        `<table cellpadding="0" cellspacing="0" class="email-template-preview preview-container"
          style="background: #ffffff;border:1px solid #d9d5d5;border-radius:10px;width:652px; padding:5px">
          <tr>
  ...
  <tr>
    ...
    },
    {
      ...
      html:
        `
       <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff" class="responsive-signature-v2" style="background: #ffffff; border: 1px solid #dbdbdb; border-radius: 10px; max-width: 652px; width: 100%;">
  <tr>
    <td>
        ...
        <tr>
          ...
          <td style="padding-left: 16px; padding-top: 16px; vertical-align: top;">
            ...
            <p style="font-weight: 400; font-size: 12px; color: #999999; margin: 4px 0;">
              ...
              <a href="${`tel:${formData.phone || "#"}`}" style="color: #1976d2; text-decoration: none;">${formData.phone || "Phone"}</a>
            </p>
            <p style="font-weight: 400; font-size: 12px; color: #999999; margin: 4px 0;">
              <span style="display: inline-block; min-width: 60px;">Email:</span>
              <a href="${`mailto:${formData.email || "#"}`}" style="color: #1976d2; text-decoration: none;">${formData.email || ""}</a>
            </p>
            <p style="font-weight: 400; font-size: 12px; color: #999999; margin: 4px 0;">
              <span style="display: inline-block; min-width: 60px;">Website:</span>
              <a href="${`${formData.website || "#"}`}" style="color: #1976d2; text-decoration: none;">${formData.website || "website"}</a>
            </p>
            <p style="font-weight: 400; font-size: 12px; color: #999999; margin: 4px 0;">
              ...
              <div className="flex-[2]">
                <div className="bg-[#031123] border border-[#112F59] rounded-lg p-4 h-full">
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
                    ...
                    <Button variant="darkOutline" onClick={handleSaveSignature} className="text-white flex items-center gap-1">
                      <Save size={16} />
                      Save Signature
                    </Button>
                  </div>
