...
const TicketsPage = () => {
  ...
  const handleAssigntoSupportTeam = async (assigne: AssigneTo) => {
    const req = { _id: selectedTickedetId, priority: assigne.priority, category: assigne.category, assignee: assigne.assigne_to }
                          ...
                          <div className="mt-3 flex items-center justify-end">
                            {ticket?.assignee ? (
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs text-white">{getEmployName(ticket?.assignee)}</span>
                              </div>
                            ) :
                              <Button
                                variant="teal"
