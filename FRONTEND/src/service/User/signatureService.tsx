...
export const getAllRecycleBinSignature = async (data: any) => {
    try {
        const res = await axios.post(`${Config.base_url}getAllRecycleBinSignature`, data )
        return res?.data
    }
    catch (err) {
        return err
...
export const deleteSignatureFromArchive = async (data: any) => {
    try {
        const res = await axios.post(`${Config.base_url}deleteSignatureFromArchive`, data )
        return res?.data
    }
    catch (err) {
        return err
...
export const restoreSignature = async (data: any) => {
    try {
        const res = await axios.post(`${Config.base_url}restoreSignature`, data )
        return res?.data
    }
    catch (err) {
        return err
