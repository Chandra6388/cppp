...
class SignatureDashboard {
    ...
    async  dashboardSummary(req, res) {
        ...
        // Convert to ObjectId (important for MongoDB match)
        ...
        const currentFilter = { createdAt: ranges.current, userId: userObjectId };
        const previousFilter = { createdAt: ranges.previous, userId: userObjectId };
        ...
        try {
            ...
            return res.send({
                ...
                current: {
                    ...
                    conversionRate: 0 // Update later if needed
                },
                percentage_change: {
