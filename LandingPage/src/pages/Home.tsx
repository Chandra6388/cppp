    ...
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            {[{
              ...
              <div 
                key={index} 
                className={`creative-card p-10 rounded-3xl text-center transition-all duration-700 hover-3d group ${isSectionVisible('quickstart') ? 'animate-scale-in-3d' : 'opacity-0'}`} 
                style={{
              ...
              >
                ...
                <Button 
                  onClick={() => {
                    if (step.actionType === 'browse') {
                      navigate('/signatures');
                    } else {
                      window.location.href = `${Config.FRONTEND_URL}login`
                    }
                  }} 
                  className="w-full btn-dark-modern text-white font-light py-3 rounded-2xl group-hover:scale-105 transition-all duration-300"
                >
                  {step.action}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {[{
              ...
              <div 
                key={index} 
                className={`creative-card p-8 rounded-3xl text-center transition-all duration-700 hover-3d group ${isSectionVisible('showcase') ? 'animate-fade-in-3d' : 'opacity-0'}`} 
                style={{
      ...
      <section id="features" data-section className="py-32 section-dark relative">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-purple-500/5 to-pink-500/5 rounded-full blur-3xl animate-float" style={{
            animationDelay: '3s'
          }}></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
            {[{
              ...
              <div 
                key={index} 
                className={`creative-card p-10 rounded-3xl text-center transition-all duration-700 hover-3d group ${isSectionVisible('features') ? 'animate-scale-in-3d' : 'opacity-0'}`} 
                style={{
                  animationDelay: `${index * 250}ms`
                }}
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {[{
              ...
              <div 
                key={index} 
                className={`creative-card p-8 rounded-3xl text-center transition-all duration-700 hover-3d group ${isSectionVisible('use-cases') ? 'animate-scale-in-3d' : 'opacity-0'}`} 
                style={{
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {[{
              ...
              <div 
                key={index} 
                className={`creative-card p-8 rounded-3xl transition-all duration-700 hover-3d group ${isSectionVisible('customer-love') ? 'animate-scale-in-3d' : 'opacity-0'}`} 
                style={{
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mb-20">
            {[{
              ...
              <div 
                key={index} 
                className={`creative-card p-10 rounded-3xl transition-all duration-700 hover-3d group ${isSectionVisible('testimonials') ? 'animate-scale-in-3d' : 'opacity-0'}`} 
                style={{
                  animationDelay: `${index * 200}ms`
                }}
              >
          ...
          <div className={`transition-all duration-1000 ${isSectionVisible('cta') ? 'animate-fade-in-3d' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-16">
              <Button 
                ...
                className="w-full sm:w-auto btn-dark-modern text-white font-light text-xl px-16 py-8 rounded-2xl hover-3d group"
              >
              ...
              <Button 
                ...
                className="w-full sm:w-auto btn-accent-dark font-light text-xl px-16 py-8 rounded-2xl hover-3d group"
              >
